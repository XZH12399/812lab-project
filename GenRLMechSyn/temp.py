...
# ==========================================
raw_input_data = """
  --- Loop 2: [1, 0, 6, 7] (Kinematic) ---
    [1|P] q=-0.3917 --> a=12.8597, al=0.1926, d=-8.5986
    [0|P] q=-1.6224 --> a=17.0354, al=0.1408, d=-2.5716
    [6|P] q=1.2447 --> a=8.8115, al=0.0031, d=2.7294
    [7|P] q=1.4872 --> a=10.3567, al=0.1041, d=2.1709
"""
